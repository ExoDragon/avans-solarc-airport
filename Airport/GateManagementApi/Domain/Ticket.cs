...
namespace GateManagementApi.Domain
{
    public class Ticket
    {
        ...
        public Ticket(string code, string gateId, string gateCode, string status, string passengerId, string passengerName, string passengerEmail, string passengerPhonenumber)
        {
            Code = code;
            GateId = gateId;
            GateCode = gateCode;
